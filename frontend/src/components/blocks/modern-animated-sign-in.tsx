        ...
        return (
          <span
            ...
            style={{
              ...
              borderWidth: '1px',
              borderColor: `rgba(120, 120, 120, ${borderOpacity / 100})`,
              top: '50%',
              left: '50%',
...
type AnimatedFormProps = {
  ...
  ssoButtons?: { id: string; label: string; loginUrl: string }[];
...
const AnimatedForm = memo(function AnimatedForm({
  ...
  return (
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      {ssoButtons && ssoButtons.length > 0 && (
        <>
          {ssoButtons.map((b) => (
            <BoxReveal
              key={b.id}
            ...
            >
              <a
                className='g-button group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-hidden hover:cursor-pointer flex items-center justify-center gap-3 text-sm hover:bg-neutral-50 dark:hover:bg-zinc-800 transition'
                href={b.loginUrl}
              >
                {b.label}
                <BottomGradient />
